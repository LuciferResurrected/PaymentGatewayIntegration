...
<body ng-app="registrationApp" ng-controller="registrationController" style="background-color: gray;">
	<div class="main">
		<div class="Container">
			<center>
			<div id="login">
				...
				<p>
								...
								<p>
									<span class="fa fa-lock"></span><input type="pin" id = "secretPin" ng-model = "secretPin"
										Placeholder="Secret Pin" required>
								</p>
								...
								<div>
									<span
										...
										class="small-text">Clear</a></span> <span
										style="width: 50%; text-align: right; display: inline-block;"><input
										type="submit" value="Submit" ng-click = "registrationvalidation();"></span>
								</div>
				</fieldset>
...
app.controller('registrationController', function($scope, $http, $compile,$timeout, $window){
